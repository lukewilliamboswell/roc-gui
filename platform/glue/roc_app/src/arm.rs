...
const _SIZE_CHECK_union_GlueStuff: () = assert!(core::mem::size_of::<union_GlueStuff>() == 48);
const _ALIGN_CHECK_union_GlueStuff: () = assert!(core::mem::align_of::<union_GlueStuff>() == 8);

const _SIZE_CHECK_GlueStuff: () = assert!(core::mem::size_of::<GlueStuff>() == 56);
...
impl GlueStuff {
    ...
    pub fn discriminant(&self) -> discriminant_GlueStuff {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_GlueStuff>(*bytes.as_ptr().add(48))
        }
    }
