        ...
        match event {
            ...
            Event::WindowEvent {
                ...
                let roc_event = match input_state {
                    ElementState::Pressed => roc_app::Event::KeyDown(to_roc_keycode(keycode)),
...
fn to_drawable(
    ...
    match elem.discriminant() {
        roc_app::discriminant_Elem::Rect => {
            ...
            let rect = elem.clone().unwrap_Rect();
            ...
            let drawable = Drawable {
                ...
                content: DrawableContent::FillRect {
                    ...
                    border_width: 1.0,
                    border_color: to_rgba(rect.color),
                },
            };

            (bounds, drawable)
        }
        roc_app::discriminant_Elem::Text => {
            // let text = unsafe { &elem.entry().text };
            let text = elem.clone().unwrap_Text();
...
fn to_roc_keycode(keycode: winit::event::VirtualKeyCode) -> roc_app::KeyCode {
    match keycode {
