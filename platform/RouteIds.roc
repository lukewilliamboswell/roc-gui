...
## Box the recursive tail so each chunk link has explicit pointer-sized
## indirection across targets. The retained-routes scaling specification
## exercises extension and retirement beyond a single chunk.
