...
The repository pre-commit hook and ordinary CI reject staged executable code,
object files, compiled libraries, and WebAssembly. Binary application data is
outside that policy; deterministic example fixtures are generated by
`python3 scripts/bootstrap.py` instead of being stored in Git.
