(test "Lift and tear down 1000 nested containers with current-state delegation"
 (steps
  (click (role button :name "Build lifted tree of 1,000"))
  (expect-count (text-prefix "Lifted item ") 1000)
