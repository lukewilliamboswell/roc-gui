(test "Nested local reset among 100 cells"
  ...
  (steps
    ...
    (expect-component-work :rendered 1 :compared 0 :skipped 0 :mounted 0 :retired 0 :ancestor-invalidations 4 :registry-visits 0 :projection-gets 13 :projection-sets 5)))
