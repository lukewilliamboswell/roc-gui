; Run the same statement 1001 times as fast as the keys allow, over a
; result of 10000 rows already on screen. Each run supersedes the one before
; it, so 1000 are interrupted or never start, and only the last result arrives.
(test "supersede 1000 queries in a row"
  (grants
    (directory "fixture"))
  (benchmark :warmups 1 :samples 3 :iterations 1 :scale 1000 :initial-size 10000 :change-size 1000)
  (steps
    ...
    (expect-task-counters 1004 _ 4 1000 0 _)))
