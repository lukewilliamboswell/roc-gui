...
(test "memory shows allocations by trigger and the resources of each run"
  ...
  (steps
    ...
    ; a new view mounts, and the inspector follows it; the tabs, capture bar,
    ; trust banner, and baseline bar are kept
    (expect-component-work :rendered 4 :skipped 4 :mounted 1 :retired 1)
