...
names tables and columns of capture schema 25, as defined by the recorder in
...
- Opening a capture with a different `schema_version` shows
  "Schema 4 is not supported; Observatory reads schema 25". Nothing is partially rendered.
...
│   ⚠ old.rgstats                schema 4 is not supported; Observatory reads schema 25    │
│                                                                                          │
...
```
┌ enter-100.rgstats ◆ │ + ─ [headless] [summary] [schema 25] [✓ final] [gaps 0] [isolated] ┐
├──────────┬──────────────────────────────────────────────────────────┬────────────────────┤
