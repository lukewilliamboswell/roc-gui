...
Viewer := [].{
	...
	render_image = |asset, transform| Elem.image(Elem.ImageProps.{ label: "Selected image", bytes: asset.bytes, format: asset.format, fit: transform.fit, grayscale: transform.grayscale, width: Fill, height: Fill, grow: True })
